    ...
    <div className="payment-drawer">
      ...
      >
        {loading ? (
          ...
          <div>
            {/* Customer Info */}
            <div className="card payment-drawer-customer-card" style={{ marginBottom: '16px', borderLeft: '4px solid var(--primary)' }}>
              <div className="card-body" style={{ padding: '14px' }}>
                <div className="payment-drawer-customer-info" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {data.invoices.map((invoice) => (
                  ...
                  >
                    <div className="card-body" style={{ padding: '14px' }}>
                      {/* Invoice Header */}
                      <div className="payment-invoice-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                        <div>
                      ...
                      <div className="payment-invoice-details-grid" style={{
                        display: 'grid',
                      ...
                      {invoice.dueAmount > 0 && (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                          ...
                          <div className="payment-invoice-amount-input" style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                            <div className="amount-field" style={{ flex: 1, position: 'relative' }}>
                              <span style={{
                                position: 'absolute',
                                left: '10px',
                                top: '50%',
